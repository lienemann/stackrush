...
export const en = {
  ...
  roomStarted: 'This game is already running.',
  roomSeats: 'Only {n} seats free — remove a name from your device and try again.',
  joinAs: 'This device brings: {names}',
  ...
  pausedTitle: 'Paused',
  confirmLeave: 'Leave the running game?',
  confirmLobby: 'Abort the round and return to the lobby?',
  showHints: 'Highlight targets',
  resumeGame: '▶ Resume game',
  shareApp: '📤 Share app',
  rotateHint: 'Best played in portrait — please rotate your device.',
  about: 'About',
...
export const de: Strings = {
  ...
  roomStarted: 'Dieses Spiel läuft bereits.',
  roomSeats: 'Nur noch {n} Plätze frei — entferne einen Namen auf deinem Gerät und versuch es erneut.',
  joinAs: 'Dieses Gerät bringt mit: {names}',
  ...
  continueGame: '▶ Weiter',
  pausedTitle: 'Pause',
  confirmLeave: 'Das laufende Spiel verlassen?',
  confirmLobby: 'Runde abbrechen und zur Lobby zurückkehren?',
  showHints: 'Ziele hervorheben',
  resumeGame: '▶ Spiel fortsetzen',
  shareApp: '📤 App teilen',
  rotateHint: 'Am besten im Hochformat spielen — bitte Gerät drehen.',
  about: 'Über',
...
Datenschutz: Die App verwendet keine Konten und keine Tracker; Einstellungen und Spiele bleiben auf Ihrem Gerät. Bei Online-Spielen werden direkte WebRTC-Verbindungen aufgebaut — Ihre IP-Adresse ist dabei für Mitspieler und für die öffentlichen Vermittlungsserver (Signaling-Relays) sichtbar. Die App wird über GitHub Pages ausgeliefert; GitHub verarbeitet dabei technische Zugriffsdaten (z. B. IP-Adressen) nach eigenen Datenschutzbestimmungen.`,
